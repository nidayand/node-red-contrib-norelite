      ...
      if (node.buffer.length > 0) {
        do {
          var foundIndex = _.findIndex(node.buffer, function (obj) {
            if (msg.instruction.payload.id == obj.instruction.payload.id && (msg.instruction.payload.dim != obj.instruction.payload.dim || msg.instruction.payload.dim != obj.instruction.payload.dim || msg.instruction.payload.color != obj.instruction.payload.color)) {
              return true;
            } else {
              return false;
            }
